...
public class ebookShop {
    public static void main(String[] args) {
        ...
        {
            String strSelect = "select id, author, title, price, qty from book";
            ...
            System.out.println("");
            //bai1
            String strSelect2= "select title,price from book where author = 'Dang Kim Thi' ";
            ...
            //y 3
            String strSelect3="select title, author, price, qty from book where author='Dang Kim Thi' or price>=30 order by price DESC, id ASC";
